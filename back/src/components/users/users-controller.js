...
export async function login (ctx) {
    try {
        ...
        // si l'utilisateur existe pas = email incorrect
        if(!potentialUserPassword[0]) throw new Error("Identifiant ou mot de passe incorrect");
        // et que le mot de passe ne match pas alors erreur
...
export async function editProfile(ctx) {
    try {
        ...
        // si l'utilisateur existe (modification du mail impossible)et que ce n'est pas celui de l'envoyeur
